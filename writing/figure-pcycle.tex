\begin{figure}[!tbp] 
    ...
    \end{tikzpicture}
    \caption{The graph $\G = ([p], E)$ formed from the black edges in the above figure is a cycle of length $p$. If $E^+$ is formed by adding the red edges in the figure to $E$, then $\G^+ = ([p], E^+)$ forms a chordal cover of $\G$.}
    \label{fig-pcycle}
\end{figure}